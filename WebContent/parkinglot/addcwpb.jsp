...
<body>
	...
	<div class="panel admin-panel">
		<div class="panel-head" id="add" align="center">
			<strong><span class="icon-pencil-square-o"></span>增加公共车车位</strong>
		...
		<div class="body-content"
			...
			<form method="post" action="addPosi.action">
				...
				<div class="form-group">
					<div class="label">
						<span class="float-right" >注:公共车车位</span> <label
							for="cw_type">车位所属类型</label>
					</div>
					<div class="field">
						<input class="input" type="text" readonly="readonly"
							name="cw_type" size="50" value="2">
					</div>
				</div>
